...
public class practica16_IMP {//Dice nota media maxima y nota mas alta del alumno
	...
	public static void main(String[] args) {
		...
		String[][] notas = { { "Espinete", "6.0", "7.2", "2.3", "5.8", "3.4" },
				{ "Don Pinpon", "7.8", "1.6", "4.6", "8", "3.1" }, { "Gustavo", "3.6", "1.4", "8.9", "3.5", "6.5" },
				{ "Triki", "2.5", "3", "8", "2.4", "8.9" } };
